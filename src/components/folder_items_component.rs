...
pub fn FolderItem(
    ...
    rsx! {
        div {
            class: "flex flex-col",
            style: if depth == 0 { "border-bottom: 1px solid var(--outline-variant);" } else { "" },
            ...
            div {
                ...
                style: match depth {
                    ...
                    1 => "background: var(--surface-container); margin: 2px 0;",
                    _ => "",
                },
                class: if depth == 0 { "hover:bg-[var(--surface-container-high)] hover:shadow-sm" } else { "hover:bg-[var(--surface-container-high)] hover:rounded-r-lg" },
                ...
                div {
                    ...
                    if has_children {
                        button {
                            class: "cursor-pointer text-[var(--on-surface-variant)] hover:text-[var(--on-surface)] mr-2 transition-all duration-150",
                    ...
                    span {
                        class: if depth > 0 { "text-[var(--on-surface)] truncate hover:text-[var(--primary)] cursor-pointer" } else { "text-[var(--on-surface)] truncate" },
                        style: match depth {
                ...
                div { class: "relative",
                    ...
                    if is_dropdown_open {
                        div {
                            ...
                            if is_parent_folder {
                                button {
                                    class: "block w-full text-left px-4 py-2 text-sm text-[var(--on-surface)] hover:bg-[var(--surface-container-highest)] transition-colors duration-100",
                                    onclick: move |_| {
                            ...
                            button {
                                class: "block w-full text-left px-4 py-2 text-sm text-[var(--error)] hover:bg-[var(--error-container)] transition-colors duration-100",
                                onclick: move |_| {
            ...
            if has_children && is_expanded() {
                div {
                    ...
                    style: "border-left-color: var(--primary-container);",
